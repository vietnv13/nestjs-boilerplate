import { Header, HeaderCenter, HeaderEnd, HeaderStart } from '@workspace/ui/components/plus/header'
  ...
  render: (args) => (
    <BlankLayout {...args}>
      ...
      <main className="flex-1 p-8">
        ...
        <p className="mt-2 text-muted-foreground">Combined with Header component</p>
      </main>
    </BlankLayout>
  ),
}
