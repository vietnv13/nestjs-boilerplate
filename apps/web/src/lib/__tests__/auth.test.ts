...
describe('setAuthCookies', () => {
  it('should set access_token and refresh_token cookies', () => {
    ...
    expect(mockSet).toHaveBeenCalledWith('access_token', 'access-123', AUTH_COOKIE_OPTIONS)
    expect(mockSet).toHaveBeenCalledWith('refresh_token', 'refresh-456', AUTH_COOKIE_OPTIONS)
  })
})
